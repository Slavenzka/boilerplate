...
import { DateRangePickerProps } from 'components/organisms/formElements/DateRangePicker/DateRangePicker.spec'
...
import { WeekDaysLocale } from 'specs/enum.spec'
        ...
        >
          ...
          <div
            className={classnames(css.calendars, {
              ...
              [css.calendarsRight]: isRightAlign,
            })}
          >
            <Datepicker
              ...
              peekNextMonth
              onChange={(evt: number | null) => {
                handleChangeRange(evt ? +evt : null, `from`)
              }}
              highlightDates={highlightedDates}
              InputComponent={Fragment}
              formatWeekDay={name => {
                return WeekDaysLocale[name]
              }}
