...
import Timepicker from 'components/organisms/formElements/Datepicker/Timepicker/Timepicker'
import { generateTimeOptions, getFormattedDate } from 'utils'
import DatePicker, { ReactDatePickerProps } from 'react-datepicker'
import 'react-datepicker/dist/react-datepicker.css'
import InputLabel from 'components/atoms/InputLabel/InputLabel'
import { DateInputType, DatepickerProps, DatepickerVariants } from 'components/organisms/formElements/Datepicker/Datepicker.spec'
...
const Datepicker = forwardRef(({
  ...
  ...props
}: DatepickerProps & Partial<ReactDatePickerProps | DatepickerProps>, ref: ForwardedRef<Dispatch<SetStateAction<boolean>>>) => {
  ...
  }, [InputComponent, error, label, renderCustomTrigger])
